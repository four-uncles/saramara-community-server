...
public enum AttachErrorCode implements ErrorCode {
    ...
    /**
     * AttachErrorCode
     * ATTACH_IMAGE_RANGE_OUT: 업로드할 수 있는 이미지 개수의 범위를 벗어날 경우 400 에러코드를 반환
     * ATTACH_CREATE_FAILED: ATTACH 테이블에 데이터를 저장할 때 문제가 발생할 경우 400 에러코드를 반환
    ...
    ATTACH_CREATE_FAILED(HttpStatus.BAD_REQUEST, "DB에 데이터를 저장할 때 문제가 발생했습니다."),
